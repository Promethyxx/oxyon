...
impl eframe::App for OxyonApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        // Vérifie les dépendances une seule fois
        ...
        // Vérifie si un process est terminé
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            // --- RUBAN MODULES (toujours visible) ---
            ...
            // --- OPTIONS DU MODULE ACTIF ---
            match self.module_actif {
                ModuleType::Archive => {
                    ui.horizontal(|ui| {
                        ui.label("Format :");
                        egui::ComboBox::from_id_salt("arfmt")
                            .selected_text(&self.format_choisi)
                            .show_ui(ui, |ui| {
                                for f in ["7z", "tar", "zip"] {
                ...
                ModuleType::Audio => {
                    ui.horizontal(|ui| {
                        ui.label("Format :");
                        egui::ComboBox::from_id_salt("afmt")
                            .selected_text(&self.format_choisi)
                            .show_ui(ui, |ui| {
                ...
                ModuleType::Doc => {
                    ui.horizontal(|ui| {
                        ui.label("Format :");
                        egui::ComboBox::from_id_salt("dfmt")
                            .selected_text(&self.format_choisi)
                            .show_ui(ui, |ui| {
                ...
                ModuleType::Image => {
                    ui.horizontal(|ui| {
                        ui.label("Format :");
                        egui::ComboBox::from_id_salt("ifmt")
                            .selected_text(&self.format_choisi)
                            .show_ui(ui, |ui| {
                ...
                ModuleType::Video => {
                    ui.horizontal(|ui| {
                        egui::ComboBox::from_id_salt("vfmt")
                            .selected_text(&self.format_choisi)
                            .show_ui(ui, |ui| {
    ...
    ui.vertical(|ui| {
        ...
        ui.horizontal(|ui| {
            ...
            // Affichage des fichiers ou message d'attente
            if self.current_files.is_empty() {
